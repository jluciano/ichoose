...
# voluntary-sustainable-certification 2013-Jul-05 ()
#--------------------------------------------------------------
...
datasetVersion="2013-Jul-05"        # DEPRECATED
versionID="2013-Jul-05"             # Came from directory name ../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions) renaming datasetVersion (deprecating datasetVersion)
...
#-----------------------------------
# manual/vsc-certification-database.xls_AuditWorkflowStatus_AO-00023.csv
sourceDir="manual"
datafile="vsc-certification-database.xls_AuditWorkflowStatus_AO-00023.csv"
data="$sourceDir/$datafile"
# Bootstrap conversion parameters (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Conversion-trigger):
subjectDiscriminator="vsc-certification-database.xls-auditworkflowstatus-ao-00023"             # Additional part of URI for subjects created; must be URI-ready (e.g., no spaces).
commentCharacter=""                 # ONLY one character; complain to http://sourceforge.net/projects/javacsv/ otherwise.
cellDelimiter=","                   # ONLY one character; complain to http://sourceforge.net/projects/javacsv/ otherwise.
header=                             # Line that header is on; only needed if not '1'. '0' means no header.
dataStart=                          # Line that data starts; only needed if not immediately after header.
