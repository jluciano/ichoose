...
# daveandnic-certification latest ()
#--------------------------------------------------------------
...
datasetID="daveandnic-certification"             # Came from directory name ../../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions)
...
#-----------------------------------
# manual/daveandnic-certification.xls_AuditReport_VR-012-DC.csv
sourceDir="manual"
datafile="daveandnic-certification.xls_AuditReport_VR-012-DC.csv"
...
subjectDiscriminator="daveandnic-certification.xls-auditreport-vr-012-dc"             # Additional part of URI for subjects created; must be URI-ready (e.g., no spaces).
...
#-----------------------------------
# manual/daveandnic-certification.xls_AuditReport_VR-092-DC.csv
sourceDir="manual"
datafile="daveandnic-certification.xls_AuditReport_VR-092-DC.csv"
data="$sourceDir/$datafile"
# Bootstrap conversion parameters (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Conversion-trigger):
subjectDiscriminator="daveandnic-certification.xls-auditreport-vr-092-dc"             # Additional part of URI for subjects created; must be URI-ready (e.g., no spaces).
commentCharacter=""                 # ONLY one character; complain to http://sourceforge.net/projects/javacsv/ otherwise.
cellDelimiter=","                   # ONLY one character; complain to http://sourceforge.net/projects/javacsv/ otherwise.
header=                             # Line that header is on; only needed if not '1'. '0' means no header.
dataStart=                          # Line that data starts; only needed if not immediately after header.
...
#-----------------------------------
# manual/daveandnic-certification.xls_certification.csv
sourceDir="manual"
datafile="daveandnic-certification.xls_certification.csv"
data="$sourceDir/$datafile"
# Bootstrap conversion parameters (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Conversion-trigger):
subjectDiscriminator="daveandnic-certification.xls-certification"             # Additional part of URI for subjects created; must be URI-ready (e.g., no spaces).
commentCharacter=""                 # ONLY one character; complain to http://sourceforge.net/projects/javacsv/ otherwise.
cellDelimiter=","                   # ONLY one character; complain to http://sourceforge.net/projects/javacsv/ otherwise.
header=                             # Line that header is on; only needed if not '1'. '0' means no header.
dataStart=                          # Line that data starts; only needed if not immediately after header.
...
#-----------------------------------
# manual/daveandnic-certification.xls_contact.csv
sourceDir="manual"
datafile="daveandnic-certification.xls_contact.csv"
data="$sourceDir/$datafile"
# Bootstrap conversion parameters (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Conversion-trigger):
subjectDiscriminator="daveandnic-certification.xls-contact"             # Additional part of URI for subjects created; must be URI-ready (e.g., no spaces).
commentCharacter=""                 # ONLY one character; complain to http://sourceforge.net/projects/javacsv/ otherwise.
cellDelimiter=","                   # ONLY one character; complain to http://sourceforge.net/projects/javacsv/ otherwise.
header=                             # Line that header is on; only needed if not '1'. '0' means no header.
dataStart=                          # Line that data starts; only needed if not immediately after header.
