...
datasetID="standard_setter"             # Came from directory name ../../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions)
...
#-----------------------------------
# manual/standard_setter.csv
sourceDir="manual"
datafile="standard_setter.csv"
