...
# flocert-certification 2013-Jul-11 ()
#--------------------------------------------------------------
...
datasetID="flocert-certification"             # Came from directory name ../../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions)
datasetVersion="2013-Jul-11"        # DEPRECATED
versionID="2013-Jul-11"             # Came from directory name ../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions) renaming datasetVersion (deprecating datasetVersion)
