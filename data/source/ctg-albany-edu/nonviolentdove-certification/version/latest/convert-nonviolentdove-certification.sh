...
# nonviolentdove-certification latest ()
#--------------------------------------------------------------
...
datasetID="nonviolentdove-certification"             # Came from directory name ../../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions)
...
#-----------------------------------
# manual/nonviolentdove-certification.xls_certification.csv
sourceDir="manual"
datafile="nonviolentdove-certification.xls_certification.csv"
...
subjectDiscriminator="nonviolentdove-certification.xls-certification"             # Additional part of URI for subjects created; must be URI-ready (e.g., no spaces).
...
#-----------------------------------
# manual/nonviolentdove-certification.xls_contact.csv
sourceDir="manual"
datafile="nonviolentdove-certification.xls_contact.csv"
data="$sourceDir/$datafile"
# Bootstrap conversion parameters (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Conversion-trigger):
subjectDiscriminator="nonviolentdove-certification.xls-contact"             # Additional part of URI for subjects created; must be URI-ready (e.g., no spaces).
commentCharacter=""                 # ONLY one character; complain to http://sourceforge.net/projects/javacsv/ otherwise.
cellDelimiter=","                   # ONLY one character; complain to http://sourceforge.net/projects/javacsv/ otherwise.
header=                             # Line that header is on; only needed if not '1'. '0' means no header.
dataStart=                          # Line that data starts; only needed if not immediately after header.
