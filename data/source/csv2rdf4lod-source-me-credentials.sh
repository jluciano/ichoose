...
source /etc/prizms/ichoose/ckan/datahub.io/csv2rdf4lod-source-me-for-ckan-credentials.sh
source /etc/prizms/ichoose/triple-store/virtuoso/csv2rdf4lod-source-me-for-virtuoso-credentials.sh
